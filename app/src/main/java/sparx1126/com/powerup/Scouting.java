...
public class Scouting extends AppCompatActivity {
    ...
    private PlusMinusEditTextLinearLayout cubesAdquireFromPlayer;
    private CheckBox playedDefenseEffectivily;
    private LinearLayout climbLayout;
    private RadioButton climbedRung;
    private RadioButton climbedRobot;
    private CheckBox canBeClimdOn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cubesAdquireFromPlayer = findViewById(R.id.cubesAdquireFromPlayer);
        playedDefenseEffectivily = findViewById(R.id.playeddefensecheck);
        ...
        canBeClimdOn = findViewById(R.id.climbOn);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                scoutingData.setCubesAdquireFromPlayer(cubesAdquireFromPlayer.getValue());
                scoutingData.setPlayedDefenseEffectivily(playedDefenseEffectivily.isChecked());
                scoutingData.setClimbedRung(climbedRung.isChecked());
                scoutingData.setClimbedOnRobot(climbedRobot.isChecked());
                scoutingData.setCanBeClimdOn(canBeClimdOn.isChecked());
